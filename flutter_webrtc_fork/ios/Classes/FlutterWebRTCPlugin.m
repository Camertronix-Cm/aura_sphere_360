...
- (instancetype)initWithChannel:(FlutterMethodChannel*)channel
  ...
  self.pixelStreams = [NSMutableDictionary new];
  self.pixelStreamTracks = [NSMutableDictionary new];
#if TARGET_OS_IPHONE
  ...
  if ([@"initialize" isEqualToString:call.method]) {
    ...
    if (track != nil && [track isKindOfClass:[RTCVideoTrack class]]) {
      ...
      FlutterRTCStreamingSink* sink =
          [[FlutterRTCStreamingSink alloc] initWithTrackId:trackId messenger:_messenger];
      [videoTrack addRenderer:sink];
      self.pixelStreams[trackId] = sink;
      self.pixelStreamTracks[trackId] = videoTrack;
      result(@{@"channelName": [NSString stringWithFormat:@"FlutterWebRTC/PixelStream/%@", trackId]});
    } else {
      result([FlutterError errorWithCode:@"createPixelStreamFailed"
