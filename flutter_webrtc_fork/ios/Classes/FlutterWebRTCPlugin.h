...
/// panorama_viewer pixel-streaming support
@property(nonatomic, strong) NSMutableDictionary<NSString*, FlutterRTCStreamingSink*>* _Nullable pixelStreams;
@property(nonatomic, strong) NSMutableDictionary<NSString*, RTCVideoTrack*>* _Nullable pixelStreamTracks;
